...
create an input for name and update the [player,setPlayer] state to include players name. In status “ Winner is ${player name} update in CheckforWinner function.
